...
![[5. Visualization1-3.png]]
여기서 get started 클릭
![[5. Visualization1-4.png]]
요런 화면에서 하라는대로 지정해준다.
![[5. Visualization1-2.png]]
고럼 로그인 창이 나오고 로그인을 하면 일딴 ㅇㅋ!

그럼이제 Telegraf를 설정해 줘야 한다.
![[5. Visualization1-5.png]]
Load Data에서 오른쪽 위에 INFLUXDB OUTPUT PLUGIN을 누르면
![[5. Visualization1-6.png]]
...
![[5. Visualization1-8.png|center|500]]
